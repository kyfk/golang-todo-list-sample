...
func (m *TodoMutation) SetDesc(s string) {
	m.desc = &s
}

// Desc returns the value of the "desc" field in the mutation.
func (m *TodoMutation) Desc() (r string, exists bool) {
	v := m.desc
	if v == nil {
		return
	}
...
// OldDesc returns the old "desc" field's value of the Todo entity.
// If the Todo object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TodoMutation) OldDesc(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *TodoMutation) Fields() []string {
	...
	if m.desc != nil {
		fields = append(fields, todo.FieldDesc)
	}
	if m.created_at != nil {
