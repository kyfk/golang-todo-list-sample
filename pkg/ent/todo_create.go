...
func (tc *TodoCreate) SetDesc(s string) *TodoCreate {
...
func (tc *TodoCreate) check() error {
	...
	if _, ok := tc.mutation.Desc(); !ok {
		return &ValidationError{Name: "desc", err: errors.New(`ent: missing required field "Todo.desc"`)}
	}
	if _, ok := tc.mutation.CreatedAt(); !ok {
...
// SetDeletedAt sets the "deleted_at" field.
func (u *TodoUpsert) SetDeletedAt(v time.Time) *TodoUpsert {
...
// SetDesc sets the "desc" field.
func (u *TodoUpsert) SetDesc(v string) *TodoUpsert {
	u.Set(todo.FieldDesc, v)
	return u
}

// UpdateDesc sets the "desc" field to the value that was provided on create.
func (u *TodoUpsert) UpdateDesc() *TodoUpsert {
	u.SetExcluded(todo.FieldDesc)
	return u
}
...
// SetDeletedAt sets the "deleted_at" field.
func (u *TodoUpsertOne) SetDeletedAt(v time.Time) *TodoUpsertOne {
...
// SetDesc sets the "desc" field.
func (u *TodoUpsertOne) SetDesc(v string) *TodoUpsertOne {
	return u.Update(func(s *TodoUpsert) {
		s.SetDesc(v)
	})
}
...
// UpdateDesc sets the "desc" field to the value that was provided on create.
func (u *TodoUpsertOne) UpdateDesc() *TodoUpsertOne {
	return u.Update(func(s *TodoUpsert) {
		s.UpdateDesc()
	})
}
...
func (u *TodoUpsertOne) ID(ctx context.Context) (id uuid.UUID, err error) {
...
func (u *TodoUpsertOne) IDX(ctx context.Context) uuid.UUID {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetDeletedAt sets the "deleted_at" field.
func (u *TodoUpsertBulk) SetDeletedAt(v time.Time) *TodoUpsertBulk {
	return u.Update(func(s *TodoUpsert) {
		s.SetDeletedAt(v)
	})
}
...
// SetDesc sets the "desc" field.
func (u *TodoUpsertBulk) SetDesc(v string) *TodoUpsertBulk {
	return u.Update(func(s *TodoUpsert) {
		s.SetDesc(v)
	})
}
...
// UpdateDesc sets the "desc" field to the value that was provided on create.
func (u *TodoUpsertBulk) UpdateDesc() *TodoUpsertBulk {
	return u.Update(func(s *TodoUpsert) {
		s.UpdateDesc()
	})
}
